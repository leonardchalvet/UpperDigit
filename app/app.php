...
function renderPage($request, $response, $args, $app, $prismic) {
    ...
    $document = NULL;
    $nType = 0;
    $arrayTypes = [ 'home', 'answer', 'cgu', 'signin', 'contact', 'form', 'dashboard', 'p404' ]; // UPDATE NAME OF CUSTOM TYPE HERE (only if exist in CONTENT)
    $arrayView  = [ 'home', 'answer', 'cgu', 'signin', 'contact', 'form', 'dashboard', 'p404' ]; // NAME IN "VIEWS" FOLDER, ALWAYS SAME POSITION BETWEEN "arrayTypes" & "arrayView"
